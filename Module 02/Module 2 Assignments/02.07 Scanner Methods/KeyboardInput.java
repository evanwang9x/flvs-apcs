...
System.out.println(title);
        ...
        System.out.print("Please enter an integer value: 23 ");
        int intValue = in.nextInt();
        System.out.println("You entered: " + intValue);
        System.out.println();

        //use the nextDouble() method to enter a decimal value
        System.out.print("Please enter a decimal value:  0.123");
        ...
        //use the next() method to enter three words on a single line
