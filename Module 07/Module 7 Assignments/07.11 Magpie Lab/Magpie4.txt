...
public class Magpie4
{
    ...
    private String getRandomResponse()
    {
        ...
        String response = "";
        String[] potentialResponses = {"Interesting, tell me more.", "Hmmm.", 
        "Do you really think so?", "You don't say.", "k...", "Quite an interesting observation young fella."  };
        if (whichResponse == 0)
        {
        ...
        {
            response =  potentialResponses[1];
        }
        else if (whichResponse == 2)
        {
            response =  potentialResponses[2];
        }
        else if (whichResponse == 3)
        {
            response =  potentialResponses[3];
        }
        else if (whichResponse == 4)
        {
            response =  potentialResponses[4];
        }
        else if (whichResponse == 5)
        {
            response =  potentialResponses[5];
        }
